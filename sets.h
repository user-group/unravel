...
# define make_set(x,a)  x=new_set; x->id = a; x->next = NULL
# define make_pair(x,a,b) x=new_pair;x->id=a;x->level=b;x->next = NULL
# define make_var(x,a,b,c) x=new_var;x->id=a;x->level=b;\
							x->code=c;x->next = NULL
