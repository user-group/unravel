...
void print_decl(type_spec, var_specs) token_ptr type_spec, var_specs;
{
    token_ptr s, t;
    type_ptr ty;
    ...
    if (type_spec)
    {
        ...
        if (type_spec->desc.decl->decl_flags & FLAG_TYPE_US)
        {
            ...
            if (type_spec)
            {
                ...
                {
                    printf("(%s) ", type_spec->desc.decl->tag->text);
                }
                s = type_spec->desc.decl->members;
                while (s)
                {
                    if (s->desc.decl)
                        print_decl(s, s->desc.decl->vars);
                    s = s->next;
                }
            }
            printf("\n    End Struct/union: ");
...
void print_token(t) token_ptr t;
{
    printf("TOKEN:");
    if (t)
    {
        ...
        if (t->text)
            printf(" (%s)", t->text);
        printf(
            " at %d(%d)-%d(%d)", t->at.line_start, t->at.col_start, t->at.line_end, t->at.col_end);
    }
    else
        printf(" is null");
    printf("\n");
...
#define _POP_ "Error recovery pops state %d, uncovers state %d\n"
                    if (yydebug)
                        (void)printf(_POP_, *yy_ps, yy_ps[-1]);
#undef _POP_
#endif
                    yy_ps--;
                    yy_pv--;
...
#line 80 "kgram.y"
    {
        yyval.tree = make_leaf(ID_OP, yypvt[-0].token);
    }
    break;
    case 2:
#line 82 "kgram.y"
    {
        yyval.tree = make_leaf(CON_OP, yypvt[-0].token);
    }
    break;
    case 3:
#line 84 "kgram.y"
...
#line 86 "kgram.y"
    {
        ...
        yyval.tree->token = yypvt[-0].token;
    }
    break;
    case 8:
#line 101 "kgram.y"
    {
        yyval.tree = make_tree(ARRAY_OP, yypvt[-3].tree, yypvt[-1].tree);
    }
    break;
    case 9:
#line 103 "kgram.y"
    {
        yyval.tree = make_tree(CALL_OP, yypvt[-2].tree, (token_ptr)NULL);
    }
    break;
    case 10:
#line 105 "kgram.y"
    {
        yyval.tree = make_tree(CALL_OP, yypvt[-3].tree, yypvt[-1].tree);
    }
    break;
    case 11:
#line 107 "kgram.y"
    {
        yyval.tree = make_tree(DOT_OP, yypvt[-2].tree, make_leaf(ID_OP, yypvt[-0].token));
    }
    break;
    case 12:
#line 110 "kgram.y"
    {
        yyval.tree = make_tree(POINTER_OP, yypvt[-2].tree, make_leaf(ID_OP, yypvt[-0].token));
    }
    break;
    case 13:
#line 113 "kgram.y"
    {
        yyval.tree        = make_tree(POST_OP, yypvt[-1].tree, (token_ptr)NULL);
        yyval.tree->token = yypvt[-0].token;
    }
    break;
    case 14:
...
#line 121 "kgram.y"
    {
        yyval.tree = make_tree(ARG_OP, yypvt[-3].tree, yypvt[-0].tree);
    }
    break;
    case 17:
#line 124 "kgram.y"
...
#line 130 "kgram.y"
    {
        yyval.tree        = make_tree(PRE_OP, yypvt[-0].tree, (token_ptr)NULL);
        yyval.tree->token = yypvt[-1].token;
    }
    break;
    case 20:
#line 132 "kgram.y"
...
#line 134 "kgram.y"
    {
        ...
        if (yypvt[-1].tree->op_code == DEREF_OP)
            yyval.tree->token = yypvt[-1].tree->token;
    }
    break;
    case 22:
#line 138 "kgram.y"
    {
        yyval.tree = make_tree(UN_OP, yypvt[-0].tree, (token_ptr)NULL);
    }
    break;
    case 23:
#line 140 "kgram.y"
    {
        yyval.tree = make_leaf(CON_OP, yypvt[-3].token);
    }
    break;
    case 24:
#line 145 "kgram.y"
    {
        yyval.tree = make_leaf(ADDR_OP, yypvt[-0].token);
    }
    break;
    case 25:
#line 147 "kgram.y"
    {
        yyval.tree = make_leaf(DEREF_OP, yypvt[-0].token);
    }
    break;
    case 26:
#line 149 "kgram.y"
    {
        yyval.tree = make_leaf(UN_OP, yypvt[-0].token);
    }
    break;
    case 27:
#line 151 "kgram.y"
...
#line 161 "kgram.y"
    {
        ...
        if ($2){if($2->desc.decl->decl_flags & FLAG_TYPE_USER_NAME)
                ...
                $$ = make_tree (CAST_OP,(token_ptr)NULL,$4);
        */
        yyval.tree = make_tree(CAST_OP, make_leaf(TYPENAME_OP, yypvt[-2].token), yypvt[-0].tree);
    }
    break;
    case 33:
#line 180 "kgram.y"
    {
        yyval.tree = make_tree(BIN_OP, yypvt[-2].tree, yypvt[-0].tree);
    }
    break;
    case 34:
#line 182 "kgram.y"
...
#line 256 "kgram.y"
    {
        yyval.tree =
            make_tree(BIN_OP, yypvt[-4].tree, make_tree(BIN_OP, yypvt[-2].tree, yypvt[-0].tree));
    }
    break;
    case 63:
#line 264 "kgram.y"
    {
        yyval.tree =
            make_tree((yypvt[-1].op == 0) ? RELASGN_OP : ASGN_OP, yypvt[-2].tree, yypvt[-0].tree);
    }
    break;
    case 64:
#line 269 "kgram.y"
...
#line 298 "kgram.y"
    {
        yyval.tree = make_tree(COMMA_OP, yypvt[-2].tree, yypvt[-0].tree);
    }
    break;
    case 79:
#line 307 "kgram.y"
...
#line 312 "kgram.y"
    {
        ...
        if (c_opt)
            print_decl(yypvt[-2].token, yypvt[-1].token);
...
#line 323 "kgram.y"
    {
        ...
        if (!yypvt[-1].token->text)
            yypvt[-1].token->text = yypvt[-0].token->text;
    }
    break;
    case 84:
#line 333 "kgram.y"
    {
        if (yypvt[-1].token && yypvt[-0].token)
            yypvt[-0].token->desc.decl->decl_flags |= yypvt[-1].token->desc.decl->decl_flags;
...
#line 379 "kgram.y"
    {
        make_decl(yypvt[-0].token, FLAG_SC_EXTERN);
    }
    break;
    case 93:
#line 381 "kgram.y"
    {
        make_decl(yypvt[-0].token, FLAG_SC_STATIC);
    }
    break;
    case 94:
#line 383 "kgram.y"
    {
        make_decl(yypvt[-0].token, FLAG_SC_AUTO);
    }
    break;
    case 95:
#line 385 "kgram.y"
    {
        make_decl(yypvt[-0].token, FLAG_SC_REGISTER);
    }
    break;
    case 96:
#line 389 "kgram.y"
    {
        make_decl(yypvt[-0].token, FLAG_TYPE_CHAR);
    }
    break;
    case 97:
#line 390 "kgram.y"
    {
        make_decl(yypvt[-0].token, FLAG_TYPE_SHORT);
    }
    break;
    case 98:
#line 391 "kgram.y"
    {
        make_decl(yypvt[-0].token, FLAG_TYPE_INT);
    }
    break;
    case 99:
#line 392 "kgram.y"
    {
        make_decl(yypvt[-0].token, FLAG_TYPE_LONG);
    }
    break;
    case 100:
#line 393 "kgram.y"
    {
        make_decl(yypvt[-0].token, FLAG_TYPE_SIGNED);
    }
    break;
    case 101:
#line 394 "kgram.y"
    {
        make_decl(yypvt[-0].token, FLAG_TYPE_UNSIGNED);
    }
    break;
    case 102:
#line 395 "kgram.y"
    {
        make_decl(yypvt[-0].token, FLAG_TYPE_FLOAT);
    }
    break;
    case 103:
#line 396 "kgram.y"
    {
        make_decl(yypvt[-0].token, FLAG_TYPE_DOUBLE);
    }
    break;
    case 104:
#line 397 "kgram.y"
    {
        make_decl(yypvt[-0].token, FLAG_TYPE_VOID);
    }
    break;
    case 107:
#line 400 "kgram.y"
    {
        make_decl(yypvt[-0].token, FLAG_TYPE_USER_NAME);
    }
    break;
    case 108:
#line 405 "kgram.y"
...
#line 433 "kgram.y"
    {
        make_decl(yypvt[-0].token, FLAG_TYPE_US | FLAG_TYPE_STRUCT);
    }
    break;
    case 113:
#line 435 "kgram.y"
    {
        make_decl(yypvt[-0].token, FLAG_TYPE_US | FLAG_TYPE_UNION);
    }
    break;
    case 115:
#line 442 "kgram.y"
...
#line 527 "kgram.y"
    {
        make_decl(yypvt[-3].token, FLAG_TYPE_ENUM);
        yypvt[-3].token->desc.decl->members = yypvt[-1].token;
    }
    break;
    case 128:
#line 529 "kgram.y"
    {
        make_decl(yypvt[-4].token, FLAG_TYPE_ENUM);
        yypvt[-4].token->desc.decl->members = yypvt[-1].token;
    }
    break;
    case 129:
#line 531 "kgram.y"
    {
        make_decl(yypvt[-1].token, FLAG_TYPE_ENUM);
        yypvt[-1].token->desc.decl->members = NULL;
    }
    break;
    case 131:
#line 537 "kgram.y"
...
#line 577 "kgram.y"
    {
        yyval.token = yypvt[-1].token;
    }
    break;
    case 140:
#line 579 "kgram.y"
    {
        modify_type(yypvt[-2].token, IS_ARRAY_OF, NO_STYLE, (token_ptr)NULL);
    }
    break;
    case 141:
#line 581 "kgram.y"
    {
        modify_type(yypvt[-3].token, IS_ARRAY_OF, NO_STYLE, (token_ptr)NULL);
    }
    break;
    case 142:
#line 583 "kgram.y"
...
#line 586 "kgram.y"
    {
        modify_type(yypvt[-4].token, IS_FUNC_RET, NEW_STYLE, yypvt[-1].token);
        in_parms = 0;
    }
    break;
    case 144:
#line 588 "kgram.y"
    {
        modify_type(yypvt[-4].token, IS_FUNC_RET, OLD_STYLE, yypvt[-1].token);
        in_parms = 0;
    }
    break;
    case 145:
...
#line 597 "kgram.y"
    {
        yyval.token = (token_ptr)((int)yypvt[-0].token + 1);
    }
    break;
    case 148:
#line 599 "kgram.y"
...
#line 603 "kgram.y"
    {
        make_decl(yypvt[-0].token, FLAG_TYPE_CONST);
    }
    break;
    case 150:
#line 604 "kgram.y"
    {
        make_decl(yypvt[-0].token, FLAG_TYPE_VOLATILE);
    }
    break;
    case 155:
#line 639 "kgram.y"
...
#line 704 "kgram.y"
    {
        ...
        {
            new = make_abstract_type(IS_PTR_TO, NO_STYLE, (token_ptr)NULL);
            if (!old)
                old = new;
            else
...
#line 788 "kgram.y"
    {
        yyval.stmt = stmt_label(yypvt[-2].token, yypvt[-0].stmt);
    }
    break;
    case 189:
#line 790 "kgram.y"
    {
        yyval.stmt = case_stmt(yypvt[-3].token, yypvt[-1].token, yypvt[-0].stmt, False);
    }
    break;
    case 190:
#line 792 "kgram.y"
    {
        yyval.stmt = case_stmt(yypvt[-2].token, yypvt[-1].token, yypvt[-0].stmt, True);
    }
    break;
    case 191:
#line 797 "kgram.y"
...
#line 812 "kgram.y"
    {
        yyval.stmt = brace_stmt(yypvt[-1].token, (token_ptr)NULL, yypvt[-0].token);
    }
    break;
    case 194:
#line 814 "kgram.y"
    {
        yyval.stmt = brace_stmt(yypvt[-2].token, yypvt[-1].stmt, yypvt[-0].token);
    }
    break;
    case 195:
#line 816 "kgram.y"
...
#line 841 "kgram.y"
    {
        yyval.stmt = join_stmt(yypvt[-1].stmt, yypvt[-0].stmt);
    }
    break;
    case 201:
#line 846 "kgram.y"
...
#line 865 "kgram.y"
    {
        yyval.stmt = if_stmt(yypvt[-4].token,
            yypvt[-2].tree,
            yypvt[-1].token,
            yypvt[-0].stmt,
            (token_ptr)NULL,
...
#line 867 "kgram.y"
    {
        yyval.stmt = if_stmt(yypvt[-6].token,
            yypvt[-4].tree,
            yypvt[-3].token,
            yypvt[-2].stmt,
            yypvt[-1].token,
...
#line 869 "kgram.y"
    {
        yyval.stmt = switch_stmt(yypvt[-4].token, yypvt[-2].tree, yypvt[-1].token, yypvt[-0].stmt);
    }
    break;
    case 206:
#line 872 "kgram.y"
...
#line 877 "kgram.y"
    {
        yyval.stmt = while_stmt(yypvt[-4].token, yypvt[-2].tree, yypvt[-1].token, yypvt[-0].stmt);
    }
    break;
    case 209:
#line 879 "kgram.y"
    {
        yyval.stmt = do_stmt(
            yypvt[-6].token, yypvt[-5].stmt, yypvt[-4].token, yypvt[-2].tree, yypvt[-0].token);
    }
    break;
    case 210:
#line 881 "kgram.y"
    {
        yyval.stmt = for_stmt(yypvt[-8].token,
            yypvt[-7].token,
            yypvt[-6].tree,
            yypvt[-5].token,
            yypvt[-4].tree,
...
#line 900 "kgram.y"
    {
        yyval.stmt = continue_stmt(yypvt[-1].token, yypvt[-0].token);
    }
    break;
    case 213:
#line 902 "kgram.y"
    {
        yyval.stmt = break_stmt(yypvt[-1].token, yypvt[-0].token);
    }
    break;
    case 214:
#line 904 "kgram.y"
    {
        yyval.stmt = return_stmt(yypvt[-1].token, (tree_ptr)NULL, yypvt[-0].token);
    }
    break;
    case 215:
#line 906 "kgram.y"
    {
        yyval.stmt = return_stmt(yypvt[-2].token, yypvt[-1].tree, yypvt[-0].token);
    }
    break;
    case 216:
#line 909 "kgram.y"
...
#line 931 "kgram.y"
    {
        ...
        while (t)
        {
            /*printf ("(mod %d style %d)",
                    t->is,t->style); */
            if ((t->is == IS_FUNC_RET) && (t->style == NEW_STYLE))
            {
                parm = t->formals;
                while (parm)
                {
...
#line 963 "kgram.y"
    {
        ...
        fprintf(outfile, ")");
        if (z_opt)
            fprintf(outfile, "    end function %s", yypvt[-3].token->text);
        fprintf(outfile, "\n");
    }
    break;
    case 228:
...
#line 989 "kgram.y"
    {
        ...
        {
            if (is_static)
                current_proc->static_or_extern = 'S';
...
#line 1021 "kgram.y"
    {
        ...
        */
        ...
        while (t)
        {
            /* printf ("(mod %d style %d)",
                    t->is,t->style);  */
            if ((t->is == IS_FUNC_RET) && (t->style == OLD_STYLE))
            {
                parm = t->formals;
                pn   = 1;
                while (parm)
